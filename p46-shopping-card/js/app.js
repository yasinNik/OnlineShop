...
function addProductToBasket(productID) {
  ...
  if (!exists) {
    // clone original so products[] stays untouched
    ...
    productBasketContainer.insertAdjacentHTML(
      ...
      <article class="basket-item">
        <div class="flex-center">
          ...
          <div>
            <div class="buttons">
              <button class="increase" onclick="increaseBtnHandler(${product.id})">
                <i class="bx bx-plus"></i>
              </button>
              <button class="remove-button" onclick="trashBtnHandler(${product.id})">
                <i class="bx bx-trash"></i>
              </button>
              <button class="decrease" onclick="decreaseBtnHandler(${product.id})">
